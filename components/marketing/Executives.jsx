...
export default function Executives() {
    ...
    const executives = [
        { name: "Fernando Dias", role: "Founder/ CEO PUC angels", link: "https://www.linkedin.com/in/fernandoscdias", image: "/fernando.jpeg", specialized: true, badge: "Founder" },
                        ...
                        {executives.map((exec, idx) => (
                            exec.specialized ? (
                                ...
                                >
                                    {/* Background Image */}
                                    <img
                                        src={exec.image || `https://ui-avatars.com/api/?name=${encodeURIComponent(exec.name)}&background=111827&color=fff&size=800`}
                                        alt={exec.name}
