                ...
                <div className="max-w-7xl mx-auto px-6 py-6">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                        <div className="flex items-center gap-4 md:gap-6">
                            <Link href="/" className="h-10 md:h-14 w-auto overflow-hidden flex items-center justify-center hover:opacity-80 transition-opacity">
                        ...
                        <div className="flex items-center gap-4 md:gap-6">
                            <nav className="flex items-center gap-2 md:gap-3">
                                ...
                                <Link href="/apply" className="nav-link text-sm md:text-base px-2 py-1">Apply</Link>
